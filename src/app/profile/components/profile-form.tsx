          ...
          <div className="space-y-8">
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel>
                    Full Name <span className="text-[#5E3BEE]">*</span>
                  </FieldLabel>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel>
                    Gender <span className="text-[#5E3BEE]">*</span>
                  </FieldLabel>
                  <select
                    {...field}
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel>
                    Date of Birth <span className="text-[#5E3BEE]">*</span>
                  </FieldLabel>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field data-invalid={fieldState.invalid}>
                  <FieldLabel>
                    Phone Number <span className="text-[#5E3BEE]">*</span>
                  </FieldLabel>
